...
$txt['customform_view_perms_desc'] = 'Restrinja los grupos de usuarios que pueden ver la lista de formularios. Los formularios individuales se ejecutan independientemente de esto, no hay herencia de permisos.';
...
$txt['customform_output_desc'] = 'Para mostrar los datos que un usuario ingresa en la publicación del foro, deberá ingresar el identificador del campo entre un conjunto de llaves <code>{{ name }}</code>.';
$txt['customform_board'] = 'Foro en el que publicar';
$txt['customform_board_desc'] = 'Seleccione el foro en el que se publicará el formulario. El foro de destino se puede ocultar.';
...
$txt['customform_type_text'] = 'Texto';
$txt['customform_type_textarea'] = 'Texto adicional';
$txt['customform_type_select'] = 'Seleccionar cuadro';
$txt['customform_type_radio'] = 'Radio de botones';
$txt['customform_type_check'] = 'Cuadro de verificación';
$txt['customform_type_info'] = 'Información';
...
$helptxt['customform_submit_exit'] = '
	<p>Esta configuración le permite seleccionar a dónde se envía al usuario después de que el formulario se complete con éxito.</p>
	<p>A continuación se enumeran varias macros que puede utilizar.</p>
	<ul class="normallist">
		<li>
			<b>Foros</b>
			&nbsp;- redirigirá al usuario al foro donde se publica el formulario (este también es el valor predeterminado si el campo se deja vacío).
		</li>
		<li><b>Foro</b>
			&nbsp;- redirigirá al usuario a la página índice del foro.
		</li>
		<li><b>Formulario</b>
			&nbsp;- redirigirá al usuario a la lista de formularios disponibles para que los llene, si tiene permiso para verlo.
		</li>
		<li><b>Gracias</b>
			&nbsp;- redirigirá al usuario a una página simple que le informará que el formulario se ha completado correctamente y le agradecerá por completar el formulario.
		</li>
	</ul>
	<p>foro, formulario y gracias, son útiles si el formulario se publica en un foro que el usuario no tiene acceso para ver.</p>
	<p>También puede ingresar una URL como <code>https://www.ejemplo.com/</code> y el usuario será dirigido a esa URL. Esto puede ser útil para redirigir a los usuarios a una página de agradecimiento personalizada, otro formulario específico, una publicación de foro específica o cualquier otro lugar en Internet.</p>
	';
